...
public class Navigator
{
                              ...
                              View navigationContentFrame)
    {
        ...
        var defaultOnBackPressedCallback = new OnBackPressedCallback(true)
        {
            @Override
            public void handleOnBackPressed()
            {
                if (mainActivity.getFragmentAtFrame() instanceof MainFragment)
                {
                    mainActivity.finish();
                    return;
                }
        ...
        mainActivity.getOnBackPressedDispatcher()
                    .addCallback(mainActivity, defaultOnBackPressedCallback);
    }
